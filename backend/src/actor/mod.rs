//! This module is essentially a vendored version of https://github.com/chubei-oppen/atomic-actor with some modification for my needs
//! 
...
//!
//! For this to be sound, `Message`s sent to the same `Actor` must be processed sequentially
//!
