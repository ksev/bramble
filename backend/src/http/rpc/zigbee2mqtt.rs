...
use crate::{database, integration::zigbee2mqtt::*, io::mqtt::MqttServerInfo};
...
impl Zigbee2MqttService for Service {
    async fn config(input: Zigbee2MqttConfig) -> Result<Zigbee2MqttServer> {
    ...
    async fn status(_: Void) -> Result<Zigbee2MqttServers> {
